...
const PurchaseInvoice = () => {
  ...
  const styles = {
    ...
    headerSection: {
      ...
      borderRadius: screenSize.isMobile ? '6px' : '8px',
      padding: screenSize.isMobile ? '10px' : screenSize.isTablet ? '14px' : '16px',
      margin: screenSize.isMobile ? '6px' : screenSize.isTablet ? '10px' : '16px',
      marginBottom: screenSize.isMobile ? '10px' : screenSize.isTablet ? '12px' : '16px',
    ...
    tableSection: {
      ...
      display: 'flex',
      flexDirection: 'column',
      minHeight: screenSize.isMobile ? '300px' : '400px',
      overflow: 'auto',
      maxHeight: screenSize.isMobile ? 'calc(100vh - 400px)' : 'calc(100vh - 350px)',
    },
    formRow: {
      display: 'flex',
      flexDirection: 'column',
    ...
    tableContainer: {
      ...
      flexDirection: 'column',
      maxHeight: 'none',
      minHeight: screenSize.isMobile ? '300px' : screenSize.isTablet ? '400px' : 'auto',
    },
    table: {
      width: 'max-content',
      minWidth: '100%',
    ...
    footerSection: {
      ...
      alignItems: 'center',
      padding: screenSize.isMobile ? '10px' : screenSize.isTablet ? '12px' : '10px 16px',
      backgroundColor: 'white',
      borderTop: '2px solid #e0e0e0',
      boxShadow: '0 -2px 8px rgba(0,0,0,0.05)',
      gap: screenSize.isMobile ? '12px' : screenSize.isTablet ? '14px' : '12px',
      flexWrap: 'wrap',
      flexShrink: 0,
      minHeight: screenSize.isMobile ? 'auto' : screenSize.isTablet ? '50px' : '60px',
      marginTop: screenSize.isMobile ? '10px' : screenSize.isTablet ? '12px' : '0',
      zIndex: 100,
      width: '100%',
      boxSizing: 'border-box',
    },
