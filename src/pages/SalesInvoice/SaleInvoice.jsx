  ...
  try {
    ...
    if (barcodeData) {
      ...
      updatedItems[currentRowIndex] = {
        ...
        sRate: String(barcodeData.rate || 0),
        qty: "",
        amount: "0.00",
      };
    ...
    /* =====================================================
       3️⃣ BARCODE WRONG → POPUP → STAY IN BARCODE
    ===================================================== */
...
/>
 ...
 <ConfirmationPopup
  ...
  onConfirm={() => {
    ...
    setTimeout(() => {
      const input = barcodeInputRefs.current[lastBarcodeRowRef.current];
      if (input) {
        input.focus();
