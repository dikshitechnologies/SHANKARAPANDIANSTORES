...
filtered = itemsData.filter(item => {
  ...
  return name
    ...
    .trim()                 // 🔥 remove spaces
    .toLowerCase()
    .startsWith(searchLower); // 🔥 STARTS WITH ONLY
});
...
<div style={styles.formField}>
  ...
  <input
    ...
    ref={billDateRef}
    onKeyDown={(e) => {
      handleHeaderArrowNavigation(e, 'billDate'); // ⬅️ ➡️
      handleKeyDown(e, mobileRef, 'billDate');    // ⏎ existing logic
    }}
