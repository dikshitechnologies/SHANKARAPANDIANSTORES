...
const ReceiptVoucher = () => {
  ...
  const styles = {
    ...
    inlineInput: {
      ...
      fontWeight: TYPOGRAPHY.fontWeight.normal,
      lineHeight: TYPOGRAPHY.lineHeight.normal,
      padding: isMobileView ? '6px 8px' : '0px 10px',
    ...
    tableContainer: {
      ...
      display: 'flex',
      flexDirection: 'column',
      minHeight: isMobileView ? '50vh' : '45vh',
    },
    table: {
      width: 'max-content',
      minWidth: '100%',
      borderCollapse: 'collapse',
      tableLayout: isMobileView ? 'auto' : 'fixed',
    },
    th: {
      fontFamily: TYPOGRAPHY.fontFamily,
      ...
      color: 'white',
      padding: isMobileView ? '4px 2px' : '6px 4px',
      textAlign: 'center',
      letterSpacing: '0.5px',
      position: 'sticky',
      top: 0,
      ...
      whiteSpace: 'nowrap',
      minWidth: isMobileView ? '40px' : '60px',
    },
    td: {
      fontFamily: TYPOGRAPHY.fontFamily,
      fontSize: TYPOGRAPHY.fontSize.sm,
      fontWeight: TYPOGRAPHY.fontWeight.medium,
      lineHeight: isMobileView ? '24px' : '30px',
      padding: 0,
      textAlign: 'center',
    ...
    editableInput: {
      ...
      padding: isMobileView ? '2px 3px' : '4px 6px',
      boxSizing: 'border-box',
      border: 'none',
      borderRadius: '4px',
      textAlign: 'center',
    ...
    <div style={styles.container}>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          input, select {
            font-size: 14px !important; /* Larger text for mobile */
            ...
            <div style={styles.fieldGroup}>
              ...
              <select
                ...
                style={{
                  ...
                  fontSize: TYPOGRAPHY.fontSize.sm,
                  fontWeight: TYPOGRAPHY.fontWeight.normal,
                  padding: isMobileView ? '8px' : '6px 8px',
