...
const ScrapPurchase  = () => {
  // --- PERMISSIONS ---
  const { checkPrintPermission } = usePrintPermission('SCRAP_PURCHASE');
  ...
  const generatePDF = () => {
    try {
      ...
      const printContent = `
        ...
        <html>
        <head>
          <title>Scrap Purchase Register</title>
          <style>
        ...
        <body>
          <h1>Scrap Purchase Register Report</h1>
          <div class="info">
          ...
          <div class="summary">
            ...
            <div class="summary-item">Total Qty: ${formatNumber(summary.totals.qty)}</div>
          </div>
        </body>
        </html>
      `;
  ...
  const exportToExcel = () => {
    try {
      // Create CSV content
      let csvContent = 'Scrap Purchase Register Report\n';
      csvContent += `Period: ${fromDate} to ${toDate}\n`;
      csvContent += `Total Records: ${summary.totalRecords}\n\n`;
      
      // Headers
      csvContent += 'No,Party Name,Voucher Date,Ref No,Bill No,Amount,Qty\n';
      ...
      csvContent += `Total Qty,${parseNumber(summary.totals.qty)}\n`;
      ...
      link.setAttribute('download', `Scrap_Purchase_Register_${fromDate}_to_${toDate}.csv`);
  ...
  return (
    <div style={styles.container}>
      ...
      <ConfirmationPopup
        ...
        message="Do you want to print the Scrap Purchase Register report?"
        confirmText="Print"
        cancelText="Cancel"
        type="info"
      />
      ...
      <ConfirmationPopup
        ...
        message="Do you want to export the Scrap Purchase Register report to Excel?"
        confirmText="Export"
        cancelText="Cancel"
        type="info"
      />
